...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
                ...
                <asp:Panel runat="server" Width="100%">
                        ...
                        <asp:GridView ID="ItemsGrid" HeaderStyle-BorderStyle="Solid" HeaderStyle-BorderColor="Black" OnSelectedIndexChanged="ItemsGrid_SelectedIndexChanged"  ShowHeaderWhenEmpty="true" EmptyDataText="No previously ordered items were found" runat="server" AutoGenerateColumns="False"  CssClass="Grid"  BackColor="White" BorderColor="#196F3D" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" DataKeyNames="MaterialID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PartNo" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" HeaderText="Part #" SortExpression="PartNo" ReadOnly="True" InsertVisible="False" />
                                    
                                <asp:BoundField DataField="MaterialDescription" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" HeaderText="Item Description"  SortExpression="MaterialDescription" ReadOnly="true" InsertVisible="false" />
                                     
                                <asp:BoundField DataField="UM" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" HeaderText="Measurement"  SortExpression="UM" ReadOnly="true" InsertVisible="false" />
                                           
                                <asp:BoundField DataField="UnitPrice" DataFormatString="{0:C}" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" HeaderText="Price $"  SortExpression="Price" ReadOnly="true" InsertVisible="false" />
                                
                                <asp:CommandField ShowSelectButton="True" SelectText="Add" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-ForeColor="#196F3D" ItemStyle-BackColor="White"   />       
            ...
            <td valign="top" align="center">
                <asp:Panel runat="server" Width="100%">
                    <asp:gridview ID="CartGrid" runat="server" HeaderStyle-BorderStyle="Solid" HeaderStyle-BorderColor="Black"  ShowHeaderWhenEmpty="true" EmptyDataText="No Items on Cart" ShowFooter="true" AutoGenerateColumns="false" OnRowDataBound="CartGrid_RowDataBound" CssClass="Grid"  BackColor="White" BorderColor="#196F3D" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                            <Columns>
                            <asp:BoundField DataField="ItemNumber" HeaderText="Item #" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-HorizontalAlign="Center" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            <asp:BoundField DataField="PartNo"  HeaderText="Part #" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-HorizontalAlign="Center" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            <asp:BoundField DataField="ItemDesc" HeaderText="Item" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-HorizontalAlign="Left" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            <asp:BoundField DataField="UM" HeaderText="Measurement" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-HorizontalAlign="Right" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            <asp:BoundField DataField="Price" HeaderText="Price $" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" ItemStyle-HorizontalAlign="Right" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            <asp:TemplateField HeaderText="Quantity" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D">
                                <ItemTemplate>
                                     <asp:TextBox ID="Qty" runat="server" AutoPostBack="true" OnTextChanged="Qty_TextChanged" Width="75px" style="text-align: center" CssClass="ui-icon-tag"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField DataField="Total" ItemStyle-HorizontalAlign="Right" HeaderText="Total $" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#196F3D" SortExpression="ItemNumber" ReadOnly="True" InsertVisible="False" />

                            </Columns>

                            <FooterStyle BackColor="#196F3D" Font-Bold="true" HorizontalAlign="Right" ForeColor="White" />
                    </asp:gridview>
                    <table>
                        <tr>
                            <td>Required Date</td>
